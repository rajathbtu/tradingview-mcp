...
export function registerUiTools(server) {
  ...
  server.tool('ui_open_panel', 'Open, close, or toggle TradingView panels (pine-editor, strategy-tester, watchlist, alerts, trading, options-chain)', {
    panel: z.enum(['pine-editor', 'strategy-tester', 'watchlist', 'alerts', 'trading', 'options-chain']).describe('Panel name'),

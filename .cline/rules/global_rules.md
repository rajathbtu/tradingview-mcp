...
The agent MUST NEVER calculate option expiry dates.

The agent MUST NEVER infer expiry from today's date.

The agent MUST NEVER construct expiry strings.

Expiry must always come from

- Broker API
- TradingView Option Chain
- NSE Calendar
- Dedicated MCP tool

Expiry is dynamic.

Treat expiry exactly like market data.